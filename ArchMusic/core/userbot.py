...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("DeluxNetwork")
                await self.one.join_chat("DeluxNetwork")
                await self.one.join_chat("DeluxNetwork")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("DeluxNetwork")
                await self.two.join_chat("DeluxNetwork")
                await self.two.join_chat("DeluxNetwork")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("DeluxNetwork")
                await self.three.join_chat("DeluxNetwork")
                await self.three.join_chat("DeluxNetwork")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("DeluxNetwork")
                await self.four.join_chat("DeluxNetwork")
                await self.four.join_chat("DeluxNetwork")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("DeluxNetwork")
                await self.five.join_chat("DeluxNetwork")
                await self.five.join_chat("DeluxNetwork")
            except:
                pass
